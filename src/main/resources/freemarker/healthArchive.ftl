            ...
            <HEALTH_EXAM_RECORD_LIST>
                <#list healthExamRecordList as healthExamRecord>
                    ...
                    <HEALTH_EXAM_RECORD ID="${healthExamRecord.id}">
                        <ENTERPRISE_INFO>
                            <!--用人单位名称-->
                            <ENTERPRISE_NAME>${healthExamRecord.enterpriseInfo.name}</ENTERPRISE_NAME>
                            <!--统一社会信用代码(18 位)-->
                            <CREDIT_CODE>${healthExamRecord.enterpriseInfo.creditCode}</CREDIT_CODE>
                            <!-- 企业类型代码-->
                            <ECONOMIC_TYPE_CODE>${healthExamRecord.enterpriseInfo.economicTypeCode}</ECONOMIC_TYPE_CODE>
                            <!--行业类别代码-->
                            <INDUSTRY_CATEGORY_CODE>${healthExamRecord.enterpriseInfo.industryCategoryCode}</INDUSTRY_CATEGORY_CODE>
                            <!--企业规模代码-->
                            <BUSINESS_SCALE_CODE>${healthExamRecord.enterpriseInfo.businessScaleCode}</BUSINESS_SCALE_CODE>
                            <!--所属地区代码-->
                            <ADDRESS_CODE>${healthExamRecord.enterpriseInfo.addressCode}</ADDRESS_CODE>
                            <!--用人单位详细地址-->
                            <ADDRESS_DETAIL>${healthExamRecord.enterpriseInfo.addressDetail}</ADDRESS_DETAIL>
                            <!--用人单位地址邮政代码-->
                            <ADDRESS_ZIP_CODE>${healthExamRecord.enterpriseInfo.addressZipCode}</ADDRESS_ZIP_CODE>
                            <!--用人单位联系人名称-->
                            <ENTERPRISE_CONTACT>${healthExamRecord.enterpriseInfo.enterpriseContact}</ENTERPRISE_CONTACT>
                            <!--用人单位联系人电话-->
                            <CONTACT_TELPHONE>${healthExamRecord.enterpriseInfo.contactTelephone}</CONTACT_TELPHONE>
                            <!--用人单位所在区全名称(如:北京市市辖区海淀区)-->
                            <ALL_NAME>${healthExamRecord.enterpriseInfo.allName}</ALL_NAME>
                        </ENTERPRISE_INFO>
                        <!--用工单位信息开始-->
                        <ENTERPRISE_INFO_EMPLOYER>
                            <!--用工单位名称-->
                            <ENTERPRISE_NAME_EMPLOYER>${healthExamRecord.enterpriseInfoEmployer.enterpriseNameEmployer}</ENTERPRISE_NAME_EMPLOYER>
                            <!--用工单位统一社会信用代码(18 位)-->
                            <CREDIT_CODE_EMPLOYER>${healthExamRecord.enterpriseInfoEmployer.creditCodeEmployer}</CREDIT_CODE_EMPLOYER>
                            <!-- 用工单位企业类型代码-->
                            <ECONOMIC_TYPE_CODE_EMPLOYER>${healthExamRecord.enterpriseInfoEmployer.economicTypeCodeEmployer}</ECONOMIC_TYPE_CODE_EMPLOYER>
                            <!--用工单位行业类别代码-->
                            <INDUSTRY_CATEGORY_CODE_EMPLOYER>${healthExamRecord.enterpriseInfoEmployer.industryCategoryCodeEmployer}</INDUSTRY_CATEGORY_CODE_EMPLOYER>
                            <!--用工单位企业规模代码-->
                            <BUSINESS_SCALE_CODE_EMPLOYER>${healthExamRecord.enterpriseInfoEmployer.businessScaleCodeEmployer}</BUSINESS_SCALE_CODE_EMPLOYER>
                            <!--用工单位所属地区代码-->
                            <ADDRESS_CODE_EMPLOYER>${healthExamRecord.enterpriseInfoEmployer.addressCodeEmployer}</ADDRESS_CODE_EMPLOYER>
                            <!--用工单位所在区全名称(如:北京市市辖区海淀区)-->
                            <ALL_NAME_EMPLOYER>${healthExamRecord.enterpriseInfoEmployer.allNameEmployer}</ALL_NAME_EMPLOYER>
                        </ENTERPRISE_INFO_EMPLOYER>
                        <!--用工单位信息结束-->
                        <!--劳动者信息开始-->
                        <WORKER_INFO>
                            <!-- 姓名 -->
                            <WORKER_NAME>${healthExamRecord.workInfo.name}</WORKER_NAME>
                            <!-- 身份证件类型代码 -->
                            <ID_CARD_TYPE_CODE>${healthExamRecord.workInfo.idCardTypeCode}</ID_CARD_TYPE_CODE>
                            <!-- 身份证件号码 -->
                            <ID_CARD>${healthExamRecord.workInfo.idCard}</ID_CARD>
                            <!-- 性别代码-->
                            <GENDER_CODE>${healthExamRecord.workInfo.genderCode}</GENDER_CODE>
                            <!-- 出生日期-->
                            <BIRTH_DATE>${healthExamRecord.workInfo.birthDate}</BIRTH_DATE>
                            <!--联系电话-->
                            <WORKER_TELPHONE>${healthExamRecord.workInfo.workerTelephone}</WORKER_TELPHONE>
                        </WORKER_INFO>
                        <!--劳动者信息结束-->
                        <!--监测类型代码-->
                        ...
                        <AUDIT_INFO>
                            <!-- 审核状态代码(必填 07 省级审核通过)-->
                            <AUDITSTATUS>${healthExamRecord.auditInfo.auditStatus}</AUDITSTATUS>
                            <!-- 审核意见 -->
                            <AUDITINFO>${healthExamRecord.auditInfo.auditInfo}</AUDITINFO>
                            <!-- 审核时间 -->
                            <AUDITDATE>${healthExamRecord.auditInfo.auditDate}</AUDITDATE>
                            <!-- 审核人姓名 -->
                            <AUDITOR_NAME>${healthExamRecord.auditInfo.auditorName}</AUDITOR_NAME>
                            <!-- 审核机构 -->
                            <AUDIT_ORG>${healthExamRecord.auditInfo.auditOrg}</AUDIT_ORG>
                        </AUDIT_INFO>
                        <!-- 审核信息结束 -->
                    </HEALTH_EXAM_RECORD>
                </#list>
